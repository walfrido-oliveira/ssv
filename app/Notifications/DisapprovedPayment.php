...
class DisapprovedPayment extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line(__('The billing of number #:number has been payment disapproved.', ['number' => $this->billing->formattedId] ))
