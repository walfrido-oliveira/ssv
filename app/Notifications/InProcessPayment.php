...
class InProcessPayment extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line(__('The billing number #:number is with the payment in process.', ['number' => $this->billing->formattedId] ))
