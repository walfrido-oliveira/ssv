...
@section('content_header')
    <h1 class="m-0 text-dark">{{ __('Budget Types') }}</h1>
@stop
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.budget-types.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('Add Budget Type') }}</i></a>
                            ...
                            @foreach($budgetTypes as $budgetType)
                                <tr>
                                    ...
                                    <td width="15%">
                                        ...
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-danger btn-sm delete-modal-click" data-toggle="modal" data-target="#delete-modal" data-id={{ $budgetType->id }}>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{route('admin.budget-types.destroy', ['budget_type' => '#'])}}" method="post" id="delete-modal-form">
                        @csrf
                        @method("DELETE")
