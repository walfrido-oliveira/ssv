...
<h1 class="m-0 text-dark">{{ __('Edit Product') }}</h1>
@stop
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-3 p-2" id="image_profile_preview_container">
                                        <img class="img-circle elevation-2 image-profine-preview" src="{{ asset($product->imageLink) }}" alt="" id="preview_image_profile">
                                    </div>
                                    <div class="col-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-8">
                                    ...
                                    {!! Form::text('name', $product->name, ['class' => 'form-control ' . $errors->first('name','is-invalid'), 'id' => 'name', 'placeholder' => __("Name")]) !!}
                                    {!! $errors->first('name','<div class="invalid-feedback">:message</div>') !!}
                                </div>
                                <div class="col-sm-4">
                                    <label for="price">{{ __('Price') }}</label>
                                    {!! Form::text('price', $product->price, ['class' => 'form-control ' . $errors->first('price','is-invalid'), 'id' => 'price', 'placeholder' => __("Price")]) !!}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    {!! Form::number('amount_in_stock', $product->amount_in_stock, ['class' => 'form-control ' . $errors->first('amount_in_stock','is-invalid'), 'id' => 'amount_in_stock', 'placeholder' => __("Initial Stock"), 'step'=>'1']) !!}
                                    {!! $errors->first('amount_in_stock','<div class="invalid-feedback">:message</div>') !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="description">{{ __('Description') }}</label>
                                {!! Form::textarea('description', $product->description, ['class' => 'form-control ' . $errors->first('description','is-invalid'), 'rows' => 4, 'id' => 'description', 'placeholder' => __("A short description for this company (do not required)")]) !!}
