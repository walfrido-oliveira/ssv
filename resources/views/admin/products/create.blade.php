                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-8">
                                    ...
                                    {!! Form::select('product_category_id', $categories, null, ['class' => 'select2-with-tag ' . $errors->first('product_category_id','is-invalid') , 'data-placeholder' => __('Category'), 'style' => 'width: 100%;']) !!}
