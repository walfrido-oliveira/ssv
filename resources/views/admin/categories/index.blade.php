        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('Add Category') }}</i></a>
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td width="15%">
                                        ...
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-danger btn-sm delete-modal-click" data-toggle="modal" data-target="#delete-modal" data-id={{ $category->id }}>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{route('admin.categories.destroy', ['category' => '#'])}}" method="post" id="delete-modal-form">
                        @csrf
                        @method("DELETE")
